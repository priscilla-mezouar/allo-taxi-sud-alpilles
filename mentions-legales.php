...
<script>
  ...
  <?php include('./includes/head-links.php'); ?>
    ...
    <title>
      Mentions légales | Allo Taxi Sud Alpilles - Votre taxi 7 jours/7 à
    ...
    <link
      rel="canonical"
      href="https://allo-taxi-sud-alpilles.com/mentions-legales.php" />
 

    <!-- Open Graph (Facebook & LinkedIn) -->
    <meta
      property="og:title"
      content="Politique de confidentialité - Allo Taxi Sud Alpilles" />
    <meta
      property="og:description"
      content="Découvrez comment nous protégeons votre vie privée avec notre politique de confidentialité." />
    <meta property="og:type" content="article" />
    <meta
      property="og:url"
      content="https://allo-taxi-sud-alpilles.com/mentions-legales.php" />
    ...
    <meta
      ...
      content="Découvrez nos mentions légales." />
    ...
    <main role="main">
      ...
      <section class="card">
        ...
        <p>
          ...
          du site allo-taxi-sud-alpilles.com l’identité des différents
          ...
          Louis Chabran Taxi –
          <a href="mailto:contact@allo-taxi-sud-alpilles.com"
            >contact@allo-taxi-sud-alpilles.com</a
          >.
          <br />
      ...
      <section class="card">
        ...
        <p>
          L’utilisation du site allo-taxi-sud-alpilles.com implique
          ...
          allo-taxi-sud-alpilles.com sont donc invités à les consulter de
          manière régulière.
          <br /><br />
          ...
          <br /><br />
          Le site allo-taxi-sud-alpilles.com est mis à jour régulièrement par la
      ...
      <section class="card">
        ...
        <p>
          Le site Allo Taxi Sud Alpilles a pour objet de fournir une information
          concernant l’ensemble des activités de la société.
          <br /><br />
          Allo Taxi Sud Alpilles s’efforce de fournir sur le site
          allo-taxi-sud-alpilles.com des informations aussi précises que
          ...
          informations.
          <br /><br />
          Tous les informations indiquées sur le site Allo Taxi Sud Alpilles sont données
          à titre indicatif, et sont susceptibles d’évoluer. Par ailleurs, les
          renseignements figurant sur le site Allo Taxi Sud Alpilles ne sont pas
      ...
      <section class="card">
        ...
        <p>
          Allo Taxi Sud Alpilles est propriétaire des droits de propriété intellectuelle
          ...
          préalable de : Allo Taxi Sud Alpilles.
          <br /><br />
      ...
      <section class="card">
        ...
        <p>
          ...
          Conseil se réserve le droit de supprimer, sans mise en demeure
          ...
          relatives à la protection des données. Le cas échéant, Allo Taxi Sud Alpilles
      ...
      <section class="card">
        ...
        <p>
          ...
          octobre 1995.
          <br /><br />
          A l’occasion de l’utilisation du site allo-taxi-sud-alpilles.com,
          peuvent êtres recueillies : l’URL des liens par l’intermédiaire
          desquels l’utilisateur a accédé au site allo-taxi-sud-alpilles.com, le
          ...
          services proposés par le site allo-taxi-sud-alpilles.com (prise de
          ...
          l’utilisateur du site allo-taxi-sud-alpilles.com l’obligation ou non
          ...
          allo-taxi-sud-alpilles.com n’est publiée à l’insu de l’utilisateur,
          échangée, transférée, cédée ou vendue sur un support quelconque à des
          tiers. Seule l’hypothèse du rachat de Allo Taxi Sud Alpilles et de ses droits
          ...
          du site allo-taxi-sud-alpilles.com.
          <br /><br />
      ...
      <section class="card">
        ...
        <p>
          Le site allo-taxi-sud-alpilles.com contient un certain nombre de liens
          hypertextes vers d’autres sites, mis en place avec l’autorisation de
          Allo Taxi Sud Alpilles. Cependant, Allo Taxi Sud Alpilles n’a pas la possibilité de
          vérifier le contenu des sites ainsi visités, et n’assumera en
          conséquence aucune responsabilité de ce fait.
          <br /><br />
          La navigation sur le site allo-taxi-sud-alpilles.com est susceptible
      ...
      <section class="card">
        ...
        <p>
          ...
          allo-taxi-sud-alpilles.com est soumis au droit français.
        </p>
      </section>
