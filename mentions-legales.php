...
<html lang="fr">
  ...
  <?php include('./includes/head-links.php'); ?>
    ...
    <meta
      property="og:title"
      content="Politique de confidentialité - Allo Taxi Sud" />
    <meta
  ...
  <?php include('./includes/header.php'); ?>
    ...
    <main role="main">
      ...
      <section class="card">
        ...
        <p>
          Le site Allo Taxi Sud a pour objet de fournir une information
          concernant l’ensemble des activités de la société.
          <br /><br />
          Allo Taxi Sud s’efforce de fournir sur le site
          ...
          informations.
          <br /><br />
          Tous les informations indiquées sur le site Allo Taxi Sud sont données
          à titre indicatif, et sont susceptibles d’évoluer. Par ailleurs, les
          renseignements figurant sur le site Allo Taxi Sud ne sont pas
      ...
      <section class="card">
        ...
        <p>
          Allo Taxi Sud est propriétaire des droits de propriété intellectuelle
      ...
      <section class="card">
        ...
        <p>
          Allo Taxi Sud ne pourra être tenu responsable des dommages directs et
          indirects causés au matériel de l’utilisateur, lors de l’accès au site
          Allo Taxi Sud, et résultant soit de l’utilisation d’un matériel ne
          répondant pas aux spécifications indiquées au point 4, soit de
          l’apparition d’un bug ou d’une incompatibilité.
          <br /><br />
          Allo Taxi Sud ne pourra également être tenue responsable des dommages
          ...
          relatives à la protection des données. Le cas échéant, Allo Taxi Sud
      ...
      <section class="card">
        ...
        <p>
          ...
          tiers. Seule l’hypothèse du rachat de Allo Taxi Sud et de ses droits
      ...
      <section class="card">
        ...
        <p>
          ...
          Allo Taxi Sud. Cependant, Allo Taxi Sud n’a pas la possibilité de
